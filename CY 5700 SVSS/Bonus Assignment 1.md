...
- **Use Precomputation for Public-Key:** If sending multiple messages to the same recipient, compute the shared secret key once using `crypto_box_beforenm` rather than executing the full key exchange on every message.
