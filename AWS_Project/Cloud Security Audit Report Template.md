...
|        |                                                                                                                                                                                                                                                                                                       |          |                                                                                                                                                                                                                                                                                                                             |                                                                                                                                                                   | **Remediated.**                                                                                                |
| 10     | S3 bucket policy did not enforce HTTPS-only (TLS) access.                                                                                                                                                                                                                                             | low      | Without the implementation of https, data being transferred to and from the bucket will be in plain text.                                                                                                                                                                                                                   | Add a bucket policy statement denying requests where `aws:SecureTransport` is `false`.                                                                            | **Remediated.**                                                                                                |
